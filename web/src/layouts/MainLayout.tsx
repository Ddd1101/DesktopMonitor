...
import { CloudUploadOutlined, DashboardOutlined, DesktopOutlined, LogoutOutlined, ShareAltOutlined } from '@ant-design/icons';
...
const MENU_ITEMS = [
  ...
  { key: '/agent-versions', icon: <CloudUploadOutlined />, label: 'Agent 版本' },
];
